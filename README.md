...
- **⏹️ Instant Stop / Cancel Extraction**: ปุ่มหยุดการทำงานสีแดงสดในแถบสถานะล่างและทุกแท็บ สั่ง Kill โปรเซสภายนอกทันทีและหยุดการสกัดแบบ Real-time
- **🗑️ One-Click Delete Extracted Assets**: ปุ่มล้างและลบสิ่งที่สกัดมาทั้งหมดในคลิกเดียว พร้อมระบบป้องกันโฟลเดอร์ระบบและคำนวณพื้นที่ที่ได้คืนอัตโนมัติ
